...
#[derive(Debug)]
pub struct MoralisGateProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MoralisGateProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MoralisGate processing");
    
    let mut processor = MoralisGateProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MoralisGateProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MoralisGateProcessor::new(false);
